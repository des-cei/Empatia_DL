...
|_| \_|\___/ \__|   |_|\___/ \__,_|\__,_|\__, |		⠀⠀⣸⣿⣿⣶⣶⣶⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣇
                                         |___/ 		⠀⣤⡟⠛⠋⠉⠙⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠉⠈⠋⠈⢿⣿⡿
                                                    ...
                                                    ⠘⢇⠀⠰⣿⣿⢟⢼⣿⣿⣿⣿⣿⣿⣿⣿⡿⢜⠿⠿⠿⠀⡀⠀⠀
@Author: Junjiao Sun                               
@Time : Created in 2:50 PM 2024/02/20   
@FileName: Data_normalization_WESAD.py                           
@Software: PyCharm


Introduction of this File:
Same as WEMAC, we also use FWN to normalize data.
"""
...
from WEMAC.Data_extraction import Abnormal_detection
...
def Normalize_data_wesad(Normalization_log_file, feature_array, If0to1=False):
...
if __name__ == '__main__':
    train_feature_name_list, test_feature_name_list, train_feature_array, test_feature_array, \
        train_label_array, test_label_array, train_P_label, test_P_label = data_extraction_wesad()
