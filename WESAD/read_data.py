...
def chest_data_label(data_set_path, subs):
    obj_data = {}
    labels = {}
    all_data = {}
    chest_data_all = {}
    for i in subs:
        ...
        chest_data_all[subject] = chest_data_dict
    ...
    return chest_data_all, labels

def execute():
    data_set_path = "C:\\Users\\JUNJIAO SUN\\Documents\\Affrctive_Computing\\WESAD"
    file_path = "ecg.txt"
    subject = 'S3'
    obj_data = {}
    labels = {}
...
if __name__ == '__main__':
    chest_data_all, labels = chest_data_label("C:\\Users\\JUNJIAO SUN\\Documents\\Affrctive_Computing\\WESAD")
    execute()
    """
