...
|_| \_|\___/ \__|   |_|\___/ \__,_|\__,_|\__, |		⠀⠀⣸⣿⣿⣶⣶⣶⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣇
                                         |___/ 		⠀⣤⡟⠛⠋⠉⠙⢿⣿⣿⣿⣿⣿⣿⣿⣿⣿⠟⠉⠈⠋⠈⢿⣿⡿
                                                    ...
                                                    ⠘⢇⠀⠰⣿⣿⢟⢼⣿⣿⣿⣿⣿⣿⣿⣿⡿⢜⠿⠿⠿⠀⡀⠀⠀
@Author: Junjiao Sun                               
@Time : Created in 4:59 PM 2024/02/19   
@FileName: train_rfe_fisher.py                           
@Software: PyCharm


Introduction of this File:
This training process include RFE-Fisher for the feature selection.
"""
...
from utils import Feature_selection_fisher_score_empatia
...
def get_train_test_rfe(train_array, test_array):
    Participants_train = set(train_array[-2, :])
    Participants_test = set(test_array[-2, :])
    ...
    for train_P in train_P_list:
        train_loc = np.where(array_all[-2, :] == train_P)
    ...
    for test_P in test_P_list:
        test_loc = np.where(array_all[-2, :] == test_P)
...
if __name__ == '__main__':
    ...
    while (train_array_rfe.shape[0] > min_feature_num):
        ...
        print(train_array_rfe.shape[0] - 3)
        ...
        rank_dic = Feature_selection_fisher_score_empatia(all_array)
        ...
        for fisher_index in range(15):
            ...
            for cross_index in range(K):
                ...
                train_array_K, test_array_K = get_train_test_rfe(train_array_now, test_array_now)
