...
import numpy
from FWN_main.methods import get_methods
from matplotlib import pyplot as plt
from FWN_main.optimizers import optimizers, evaluation
...
class FWN:
    def __init__(self, methods='ALL', include_un=True, optimizer='ALO', Population=10, Iterations=100, cpus=None,
                 viewi=0):
        self.methods = methods
        self.include_un = include_un
